...
CREATE TABLE `finance` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_finance_USER_ID` (`USER_ID`),
  CONSTRAINT `FK_finance_USER_ID` FOREIGN KEY (`USER_ID`) REFERENCES `user` (`ID`)
...
INSERT INTO `finance` (`ID`,`DATE`,`USER_ID`) VALUES 
 (3,'2010-08-10',1),
 (6,'2010-08-10',1);
...
--
-- Definition of table `finantial_month_finance`
--

DROP TABLE IF EXISTS `finantial_month_finance`;
CREATE TABLE `finantial_month_finance` (
  `FinantialMonth_DATE` date NOT NULL,
  `monthFinances_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`FinantialMonth_DATE`,`monthFinances_ID`),
  KEY `FK_finantial_month_finance_monthFinances_ID` (`monthFinances_ID`),
  CONSTRAINT `FK_finantial_month_finance_FinantialMonth_DATE` FOREIGN KEY (`FinantialMonth_DATE`) REFERENCES `finantial_month` (`DATE`),
  CONSTRAINT `FK_finantial_month_finance_monthFinances_ID` FOREIGN KEY (`monthFinances_ID`) REFERENCES `finance` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `finantial_month_finance`
--

/*!40000 ALTER TABLE `finantial_month_finance` DISABLE KEYS */;
INSERT INTO `finantial_month_finance` (`FinantialMonth_DATE`,`monthFinances_ID`) VALUES 
 ('2010-08-01',3),
 ('2010-08-01',6);
/*!40000 ALTER TABLE `finantial_month_finance` ENABLE KEYS */;
...
CREATE TABLE `income` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_income_FINANCE_ID` (`FINANCE_ID`),
  KEY `FK_income_TYPE_ID` (`TYPE_ID`),
  CONSTRAINT `FK_income_TYPE_ID` FOREIGN KEY (`TYPE_ID`) REFERENCES `income_type` (`ID`),
  CONSTRAINT `FK_income_FINANCE_ID` FOREIGN KEY (`FINANCE_ID`) REFERENCES `finance` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `income` (`ID`,`DESCRIPTION`,`VALUE`,`TYPE_ID`,`FINANCE_ID`) VALUES 
 (2,NULL,NULL,1,NULL),
 (5,NULL,NULL,1,NULL);
...
CREATE TABLE `outcome` (
  ...
  KEY `FK_outcome_FINANCE_ID` (`FINANCE_ID`),
  CONSTRAINT `FK_outcome_FINANCE_ID` FOREIGN KEY (`FINANCE_ID`) REFERENCES `finance` (`ID`),
...
INSERT INTO `outcome` (`ID`,`DESCRIPTION`,`VALUE`,`FINANCE_ID`,`TYPE_ID`) VALUES 
